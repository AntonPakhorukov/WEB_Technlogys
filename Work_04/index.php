<?php
$name = "Tristan";
$profession = "HomePizduk";
$city = "Novosibirsk";
$e_mail = "miau@kus.ru";
$phone_number = +77128134556;
$skills = [
    [
        'name' => 'Фотошоп',
        'percent' => 30,
...
$work = [
    ...
    [
        ...
        'endDate' => '01.06.2023',
        'description' => 'Manager of group',
    ],
    [
        'speciality' => 'Gradient',
        'startDate' => '01.06.2010',
        'endDate' => '01.09.2015',
        'description' => 'Manager of sales',
    ],
    [
        'speciality' => 'ArsiSitek',
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <?php for ($j = 0; $j < count($work); $j++): ?>
              <div class="w3-container">
              <h5 class="w3-opacity"><b><?= $work[$j]["speciality"];?></b></h5>
              <?php if ($work[$j]["endDate"] == "Current"): ?>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $work[$j]["startDate"];?> - <span
                  class="w3-tag w3-teal w3-round">Current</span></h6>
                  <?php endif;?>
              <?php if ($work[$j]["endDate"] != "Current"): ?>
                <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $work[$j]["startDate"];?> - <?= $work[$j]["endDate"];?><span
                  class="w3-tag w3-teal w3-round"></span></h6>
                  <?php endif?>
              <p><?= $work[$j]["description"];?></p>
              <hr>
